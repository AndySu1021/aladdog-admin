  ...
  <div class="dashboard-container">
    <div style="background-color: white;padding: 32px;border-radius: 8px;">
      ...
      <ElRadioGroup v-model="form.payment_id">
        <ElRadio v-for="payment in payments" :key="payment.id" :label="payment.id" border style="padding: 16px;height: 110px;">
        ...
        <ElButton :icon="Plus" style="height: 110px;" @click="handleAddPayment">新增付款方式</ElButton>
      </ElRadioGroup>
