      ...
      <ElCol :span="12">
        <DashboardPanel>
          <div style="display: flex; justify-content: space-between; align-items: center">
            <div
              style="display: inline-flex; align-items: center; font-size: 18px; font-weight: bold"
            >
              酒品排行 TOP5
              <ElTooltip effect="dark" content="一個月內酒品排行 TOP5" placement="top">
      ...
      <ElCol :span="12">
        <DashboardPanel>
          <div style="display: flex; justify-content: space-between; align-items: center">
            ...
            >
              餐點排行 TOP5
              <ElTooltip effect="dark" content="一個月內餐點排行 TOP5" placement="top">
                <ElIcon style="margin-left: 8px" :size="16">
                  <Warning />
                </ElIcon>
              </ElTooltip>
